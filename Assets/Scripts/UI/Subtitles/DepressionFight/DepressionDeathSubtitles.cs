...
public class DepressionDeathSubtitles : MonoBehaviour
{
    //This is how we create a TextMeshPro object
    public TMP_Text depressionSubtitle;
    ...
    IEnumerator TheSequence()
    {
        ...
        foreach (char letter in sentence.ToCharArray())
        {
            ...
            depressionSubtitle.text += letter;
        ...
        sentence = "We're just wasting our time...";
        foreach (char letter in sentence.ToCharArray())
        {
            depressionSubtitle.text += letter;
            yield return new WaitForSeconds(textSpeed);
