...
public class DepressionPrefight : MonoBehaviour
{
    ...
    IEnumerator TheSequence()
    {
        ...
        string sentence = "Why doesn't anything work...";
        ...
        sentence = "What's the point of anything anymore...";
        foreach (char letter in sentence.ToCharArray())
        {
            subtitle.text += letter;
            yield return new WaitForSeconds(textSpeed);
        ...
        sentence = "I'd be better of just done and gone...";
        foreach (char letter in sentence.ToCharArray())
        {
            subtitle.text += letter;
            yield return new WaitForSeconds(textSpeed);
